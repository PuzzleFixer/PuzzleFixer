Shader "Instanced/InstancedIndirectO" 
{
	Properties{
...
#pragma instancing_options procedural:setup
        ...
        float4 LightingmyLightModel(SurfaceOutput s,float3 ligerDir,half3 viewDir,half atten)
         {
            float4 c;
            c.rgb = s.Albedo;
            c.a = s.Alpha;
	...
	void setup()
	{
		...
		float size = nodeBuffer[unity_InstanceID].size;
